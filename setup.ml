...
(* OASIS_START *)
(* DO NOT EDIT (digest: f10ce487d0adec83bb4ef4632bcb860d) *)
(*
...
let setup_t =
  {
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "demo1"]
                   });
               Executable
                 ({
                     cs_name = "demo2";
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "demo2"]
                   })
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\0016H\135\175\190\026\243\227\183;\167\176d-\137";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
