...
(* OASIS_START *)
(* DO NOT EDIT (digest: 24acbf0250f0fa5f714ac07b21bfe778) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("netclient",
                               Some (OASISVersion.VGreaterEqual "4.0.0"));
                   ...
                   {
                      lib_modules =
                        ["Neorest"; "Helpers"; "Neo4j_result"; "Neo4j_cypher"
                        ];
                      lib_pack = false;
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_command = [(OASISExpr.EBool true, ("$demo1", []))];
                      test_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)]
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "demo2.ml"});
               Test
                 ({
                     cs_name = "demo2";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      test_type = (`Test, "custom", Some "0.4");
                      test_command = [(OASISExpr.EBool true, ("$demo2", []))];
                      test_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)]
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for ocaml-neo4j";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\197\241\139\187\031\184\139\197\246\227\173\160\136j\249\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
